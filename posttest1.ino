...
#define LED1 D4  // Pemilihan Pin D0
#define LED2 D1    // Pemilihan Pin D1

const char* ssid = "Xiaomi 13T";       // Nama SSID AP/Hotspot
const char* password = "dhiya123";    // Password Wifi
